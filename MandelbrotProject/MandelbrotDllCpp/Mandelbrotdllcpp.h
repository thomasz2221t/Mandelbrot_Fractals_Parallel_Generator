...
extern "C" MANDELBROTCPP_API long  generateMandelbrotFraktalCpp(byte * imageBuffer, long subTabBeginPoint, long sizeOfSubTable, int dimensionX, int dimensionY, long maxIteration, double minR, double maxR, double minI, double maxI);
